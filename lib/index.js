...
/**
    ...
    @param [in] merge   - Short and long argument names to merge
                            Example: {'h': 'help', 'i': 'input'}

    Parses a unix like command line

    Example:

        parseParams('program -i inputfile.txt -rf --delete now', {'i': 'input', 'r': 'reverse', 'f': 'fix', 'd': 'delete'})
